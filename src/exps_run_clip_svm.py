...
output_filename=f"out_results/clip/exps_res_svm.jsonl"#{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}
                    ...
                    for dataset in datasets:
                        ...
                        for max_iter in max_iter_list:   
                            ...
                            for use_batch in batch_values:
                                ...
                                if use_batch:
                                    new_exp_params["alpha"]=0
                                    new_exp_params["beta"]=1
                                else:
                                    if k_neg==0:
                                        new_exp_params["alpha"]=0.5
                                        new_exp_params["beta"]=0.5
                                    else:
                                        new_exp_params["alpha"]=0.75
                                        new_exp_params["beta"]=0.25
