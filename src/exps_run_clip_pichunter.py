...
#in questo test non uso mai i negativi - poi li confrontiamo con quelli che usano i negativi 
...
output_filename=f"out_results/clip/exps_res_pichunter.jsonl"#{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}
