...
output_filename=f"out_results/clip/exps_results_grid_search_svm_incr.jsonl"
              ...
              for seed in seeds:   
                    for dataset in datasets:
                        ...
                        for max_iter in max_iter_list:   
                            ...
                            for use_batch in [False]:
                                method="SVM"
                                data_preprocessing="L2_normalized"
                                new_exp_params=get_params(exp_params,method," ", data_preprocessing, use_batch)
